...
public class ProfileTransformer {
	...
	private Namespaces createNamespaces(String profileUrl){
		...
		namespaces.getNamespace().add(new Namespace("parthenos", "http://parthenos.d4science.org/handle/Clarin/VLO/")); /**http://parthenos.d4science.org/handle/Clarin/VLO produces something like http://parthenos.d4science.org/handle/Clarin/VLODataset/Meertens%20collections%3A%20PILNAR BUT we 
		                                                                                                                need something like http://parthenos.d4science.org/handle/Clarin/Dataset/Meertens%20collections%3A%20PILNAR */
