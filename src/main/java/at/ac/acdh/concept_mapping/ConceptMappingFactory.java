...
import at.ac.acdh.concept_mapping.CMDI2CIDOCMap.Property;
	...
	public static Profile2CIDOCMap getMapping(String profileSchemaUrl) throws VTDException{
		...
		for(ParthenosEntity entity: xml.entities){
			...
			for(Property property: entity.properties){
				...
				propertyMapList.add(new PropertyMap(property.name, property.relationship, patterns, property.intermediates, property.type));		
			}
